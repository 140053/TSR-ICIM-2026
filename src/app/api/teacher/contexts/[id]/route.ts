// /api/teacher/contexts/[id]
// PATCH  → update label/description/icon/color/isActive/sortOrder (teacher or admin)
// DELETE → delete context, blocked if any module references it (teacher or admin)
...
function isAllowed(role: string) { return role === "TEACHER" || role === "ADMIN"; }
